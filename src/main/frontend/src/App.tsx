...
function App() {
  ...
  const save = () => {
    const requestOptions = {
      ...
      body: JSON.stringify({ title: todoItem, columnName: 'To Do' }),
    };
                ...
                <div className="title" {...provided.droppableProps} ref={provided.innerRef}>
                  <div className="rcorners2">
                    ...
                    <div style={{ padding: '10px' }}>
                      {todos
                        .filter((todo) => todo.columnName === 'To Do')
                        .map(({ id, title }, index) => {
                          return (
                ...
                <div {...provided.droppableProps} ref={provided.innerRef}>
                  <div className="rcorners2">
                    ...
                    <div style={{ padding: '10px' }}>
                      <div>
                        {todos
                          .filter((todo) => todo.columnName === 'Progres')
                          .map((todo, index) => (
